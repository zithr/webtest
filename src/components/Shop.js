                            ...
                            <Popup
                                trigger={
                                    <button className="border-2 border-yellow-50 rounded-sm focus:outline-none focus:border-purple-200">
                                        ...
                                        >
                                            <path
                                                d="M11.5858 27H6C5.73478 27 5.48043 26.8946 5.29289 26.7071C5.10536 26.5195 5 26.2652 5 26V20.4142C5 20.2829 5.02587 20.1528 5.07612 20.0315C5.12638 19.9102 5.20004 19.7999 5.29289 19.7071L20.2929 4.70708C20.4804 4.51954 20.7348 4.41418 21 4.41418C21.2652 4.41418 21.5196 4.51954 21.7071 4.70708L27.2929 10.2929C27.4804 10.4804 27.5858 10.7348 27.5858 11C27.5858 11.2652 27.4804 11.5195 27.2929 11.7071L12.2929 26.7071C12.2 26.7999 12.0898 26.8736 11.9685 26.9239C11.8471 26.9741 11.7171 27 11.5858 27Z"
                                                stroke="black"
                                                stroke-width="2"
                                            ...
                                            />
                                            <path
                                                d="M11.9361 26.9361L5.0636 20.0636"
                                                stroke="black"
                                                stroke-width="2"
                                                stroke-linecap="round"
                                                stroke-linejoin="round"
                            ...
                            >
                                {(close) => (
                                    <div className="bg-yellow-50">
                                        ...
                                        <div className="pt-2">
                                            <button
                                                className="rounded-md px-2 bg-purple-200 hover:bg-purple-400 focus:outline-none"
                                                onClick={() => {
                                                    close()
                                            ...
                                            <button
                                                className="rounded-md px-2 ml-2 bg-red-100 hover:bg-red-200 focus:outline-none"
                                                onClick={close}
                                            >
                                                Close
                                            </button>
